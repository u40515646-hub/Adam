...
const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  const icons: { [key: string]: JSX.Element } = {
    ...
    trophy: <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 001.05-3.375 9.75 9.75 0 00-1.05-3.375h9.75m0 6.75a9.75 9.75 0 001.05-3.375 9.75 9.75 0 00-1.05-3.375m-9.75 0h9.75M9 12V6a3 3 0 013-3h0a3 3 0 013 3v6m-9 0h9" />,
